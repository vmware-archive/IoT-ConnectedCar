...
public class TypeConversionTransformerConfiguration {
	...
	@Autowired
	private TypeConversionTransformer transformer;
	...
	@MessageEndpoint
	public static class TypeConversionTransformer {
		private static final Logger logger =
				LoggerFactory.getLogger(TypeConversionTransformer.class);

		private final ObjectMapper mapper;

		public TypeConversionTransformer() {
